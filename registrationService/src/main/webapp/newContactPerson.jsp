...
<div class="container">
    <form:form method="POST" action="/auth/createContactPerson" modelAttribute="contactPerson">
        ...
        <div class="form-group">
            <form:input type="checkbox" path="referrence" id="referrence" label="Is Referrence Contact?" checked="true" readonly="readonly"></form:input>
        </div>
        <div class="form-group">
            <form:input type="checkbox" path="emergency" id="emergency" label="Is Emergency Contact?"></form:input>
        </div>
